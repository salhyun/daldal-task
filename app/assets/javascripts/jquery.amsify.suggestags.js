...
(function($) {
    ...
    $.fn.amsifySuggestags = function(options, method) {
        ...
        $.fn.addTag = function(value) {
            this.each(function () {
                // console.log('ass name = ' + $(this).attr('name'));
                // console.log(amsifies[$(this).attr('name')]);
                amsifies[$(this).attr('name')].addTag(value);
            });
        };
        $.fn.getTagNames = function() {
            return amsifies;
        }
        ...
        AmsifySuggestags.prototype = {
            ...
            createHTML : function() {
              ...
              var listArea              = '<div class="'+this.classes.listArea.substring(1)+'" style="border-radius: 0.2rem"></div>';
            ...
            addTag : function(value) {
              ...
              var html  = '<span class="'+this.classes.tagItem.substring(1)+'" data-val="'+value+'"></span>';
              $item = $(html).insertBefore($(this.selectors.sTagsInput));
              $item.text(value + ' ');
              $item.append(this.setIcon());
            ...
            setIcon : function() {
              ...
              if(settings.type == 'bootstrap') {
                return '<span class="fa fa-times '+removeClass+'" style="vertical-align: middle"></span>';
              } else if(settings.type == 'materialize') {
                return '<i class="material-icons right '+removeClass+'" style="vertical-align: middle">clear</i>';
              } else {
        ...
        return this.each(function() {
            (amsifies[$(this).attr('name')] = new AmsifySuggestags)._init(this);
            // console.log(amsifies);
        });
    };
